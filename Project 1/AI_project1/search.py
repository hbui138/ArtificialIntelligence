        ...
        if current_state not in visited:
            ...
            for next_state, action, _ in problem.getSuccessors(current_state):
                if next_state not in visited:
                    ...
                    myStack.push((next_state, new_actions))
...
def breadthFirstSearch(problem):
    ...
    while not myQueue.isEmpty():
        current_state, actions = myQueue.pop()
        ...
        if current_state not in visited:
            ...
            for next_state, action, _ in problem.getSuccessors(current_state):
                if next_state not in visited:
                    new_actions = actions + [action]
                    myQueue.push((next_state, new_actions))
...
def uniformCostSearch(problem):
    ...
    visited = set()
    start_state = problem.getStartState()
    myQueue.push((start_state, [], 0), 0)

    while not myQueue.isEmpty():
        current_state, actions, current_cost = myQueue.pop()
        ...
        if current_state not in visited:
            ...
            for next_state, action, step_cost in problem.getSuccessors(current_state):
                if next_state not in visited:
                    ...
                    myQueue.push((next_state, new_actions, new_cost), new_cost)
    return []
    ...
    while not frontier.isEmpty():
        ...
        for next_state, action, step_cost in problem.getSuccessors(current_state):
            if next_state not in visited:
                ...
                frontier.update((next_state, new_actions, new_cost), priority)
